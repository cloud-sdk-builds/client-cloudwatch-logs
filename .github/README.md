...
[`@aws-sdk/client-cloudwatch-logs`](https://www.npmjs.com/package/@aws-sdk/client-cloudwatch-logs/v/3.391.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch-logs@3.391.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uAxDiJZte+u2NfJx2Q43rES/74sKsbvfKgblNhxOwWvLVBEQWXrpcS5Eq8hohTfY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudwatch-logs": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch-logs@3.391.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudwatch-logs@3.391.0/index.min.mjs": "sha384-uAxDiJZte+u2NfJx2Q43rES/74sKsbvfKgblNhxOwWvLVBEQWXrpcS5Eq8hohTfY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudwatch-logs/blob/refs/tags/3.391.0/LICENSE
```
